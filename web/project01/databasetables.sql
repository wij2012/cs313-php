...
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('2', '4', '3', '2018-06-04');

--enter some match results
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('2','1', '2', '2018-07-20');
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('3','2', '2', '2018-07-20');
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('4','3', '3', '2018-07-20');
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('4','1', '4', '2018-07-20');
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('2', '4', '4', '2018-06-04');
INSERT INTO match(player1, player2, winner, datePlayed) VALUES ('1', '3', '0', '2018-06-04');
...
--other try for match and players join
SELECT match.id
, players.name
, players.name
, players.name
